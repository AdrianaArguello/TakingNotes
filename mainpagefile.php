    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-custom navbar-light">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active"><a class="nav-link" href="mainpagefile.php">Archivos</a></li>
            </ul>
            <ul class="navbar-nav">
        ...
        <div class="row">
            <div class="col-md-offset-3 col-lg-12">
                <div class="d-flex justify-content-between buttons">
                    <div>
                        <button id="addFile" type="button" class="btn btn-custom3">Nuevo Archivo</button>
                        <button id="allfiles" type="button" class="btn btn-custom3">Volver</button>
                    </div>
                    <div >
                        <button id="rename" type="button" class="btn btn-custom3">Guardar cambios</button>
                        <button id="edit" type="button" class="btn btn-custom3">Eliminar archivos</button>
                        <button id="done" type="button" class="btn btn-custom3">Hecho</button>
                    </div>
                </div>
                <div id="folderPad" class="formulario">
                    <form method="post" id="form">
                        <div class="form-group">
                            <label for="filename">Ingresa el nombre del archivo</label>
                            <input type="text" class="form-control" id="filename" name="filename" required>
                        </div>
                        <div class="form-group" class="id_100">
                            <label for="foldername">Selecciona el directorio</label>
                            <select class="form-control" id="foldername" name="foldername" required>
                                <option value="Default">Default-</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="filecontent">Ingresa el contenido del archivo</label>
                            <textarea id="filecontent" name="filecontent" value="Texto de prueba"  rows="10" required></textarea>
                        </div>
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-custom3 send">Enviar</button>
                        </div>
                    </form>
                    <!-- <label for="foldername">Nombre del archivo</label>
